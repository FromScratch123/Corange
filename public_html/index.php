...
<!-- signup drawer -->    
    <div class="signup-drawer">
      ...
      <div class="sigup-drawer__content-wrap">
        ...
        <p class="signup-drawer__to-signin fz--small">or <a class="color--blue" href="./login.php">Log In</a> your account</p>
  ...
  <section id="require-userinfo" class="require-userinfo">
      <div class="require-userinfo__content-wrap">
        ...
        <p class="require-userinfo__to-signin fz--small">or <a class="color--blue" href="./login.php">Log In</a> your account</p>
        <p class="has-error margin--0"><?= $app->getErrors('empty'); ?></p>
        <form action="" method="post">
        <!-- surname -->
        <label for="surname">
